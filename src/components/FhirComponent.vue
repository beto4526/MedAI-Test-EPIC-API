...
<template>
    ...
    <div class="container">
      <div style="text-align: center">
        ...
        <p><strong>Username:</strong> fhircamilas</p>
  ...
  export default {
    data() {
      return {
        ...
        patient: "",
        patientdata: {},
        clientId: "893fa4d0-3728-4f19-998a-b6e6ef44ecb2", // Replace with your client id
        redirect: process.env.PROD
    ...
    computed: {
      authorizeLink() {
        return `https://fhir.epic.com/interconnect-fhir-oauth/oauth2/authorize?response_type=code&redirect_uri=${this.redirect}&client_id=${this.clientId}&state=12345&scope=patient.read, patient.search`;
      },
    },
    async mounted() {
